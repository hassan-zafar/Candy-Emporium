...
import 'package:candy_emporium/models/fav_cart.dart';
import 'package:candy_emporium/models/mailTemplate.dart';
import 'package:candy_emporium/models/users.dart';
import 'package:candy_emporium/payment/showDialogToDismiss.dart';
import 'package:candy_emporium/profileScreens/address.dart';
import 'package:candy_emporium/tools/CommonFunctions.dart';
import 'package:candy_emporium/tools/notificationHandler.dart';
...
class _CheckOutState extends State<CheckOut> {
  ...
  getAddresses() async {
    ...
    snapshot.docs.forEach((doc) {
      AddressModel userAddress = AddressModel.fromDocument(doc);
  ...
  mailFunction({String orderId, AddressModel deliveryAddress}) {
    // var tempPrice = double.parse(e.productPrice) * e.quantitySelected;
    // String ttlProductPrice = "$tempPrice";
