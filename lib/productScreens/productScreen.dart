...
import 'package:candy_emporium/adminScreens/addEditProducts.dart';
import 'package:candy_emporium/adminScreens/commentsNChat.dart';
...
class _ProductScreenState extends State<ProductScreen> {
  ...
  addReview() async {
    ...
    snapshots.docs.forEach((e) {
      allAdmins.add(UserModel.fromDocument(e));
    });
